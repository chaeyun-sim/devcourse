          ...
          <div className="order-info">
            ...
            <form className="delivery">
              ...
              <fieldset>
                <label>상세 주소</label>
                <div className="input">
                  <InputText {...register('addressDetail', { required: true })} />
                </div>
              </fieldset>
              {errors.addressDetail && <p className="error-text">상세 정보를 입력해 주세요.</p>}

              <fieldset>
                <label>수령인</label>
                <div className="input">
                  <InputText {...register('receiver', { required: true })} />
                </div>
              </fieldset>
              ...
              <fieldset>
                <label>전화번호</label>
                <div className="input">
                  <InputText {...register('contact', { required: true })} />
                </div>
              </fieldset>
